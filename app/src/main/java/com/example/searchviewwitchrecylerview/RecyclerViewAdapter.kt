...
class RecyclerViewAdapter(context: Context, var DocsName: ArrayList<String>,var listes : ArrayList<String>,view : View) : RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder>() {
